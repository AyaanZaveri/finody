...
const Sidebar = () => {
  ...
  return (
    <div className={`flex items-center h-full z-20 fixed select-none`}>
      ...
      />
      <div
        className="border-r border-stone-100 dark:border-stone-800 to-emerald-500/20 h-full flex flex-col justify-start items-start"
        ref={sidebarRef}
      ...
      >
        <div className="px-2 w-full flex flex-col gap-1 pt-24">
          <div
            onClick={() => router.push("/")}
            className="relative inline-flex w-full text-stone-700 dark:text-white hover:shadow-xl hover:text-white hover:shadow-emerald-500/30 items-center hover:bg-emerald-500 active:bg-emerald-600 py-1 break-all rounded-md px-4 transition duration-300 ease-in-out hover:cursor-pointer"
          >
          ...
          <div
            ...
            className="relative mt-8 inline-flex w-full text-stone-700 dark:text-white hover:shadow-xl hover:text-white hover:shadow-emerald-500/30 items-center hover:bg-emerald-500 active:bg-emerald-600 py-1 break-all rounded-md px-4 transition duration-300 ease-in-out hover:cursor-pointer"
          >
            <span className="inline-flex gap-2 items-center transition-none">
          ...
          {playlists.map((playlist: any) => (
            <div
              ...
              key={playlist.Id}
              className="relative mt-1 hover:underline hover:decoration-2 hover:decoration-emerald-500 inline-flex w-full text-stone-700 dark:text-white hover:text-white items-center py-1 break-all rounded-md px-4 transition duration-300 ease-in-out hover:cursor-pointer"
            >
              <img
