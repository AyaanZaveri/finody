  ...
  return (
    ...
    >
      <img
        ...
        alt=""
      />
      <div className="border-r border-slate-100 dark:border-slate-800 w-60 to-sky-500/20 h-full flex flex-col justify-start items-start">
        <div className="px-2 w-full flex flex-col gap-1 pt-24">
          <div
            onClick={() => router.push("/")}
            className="relative inline-flex w-full text-slate-700 dark:text-white hover:shadow-xl hover:text-white hover:shadow-sky-500/30 items-center hover:bg-sky-500 active:bg-sky-600 py-1 break-all rounded-md px-4 transition duration-300 ease-in-out hover:cursor-pointer"
          >
