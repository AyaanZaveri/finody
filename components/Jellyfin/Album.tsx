      ...
      <button className="flex flex-col gap-4 items-start">
        ...
        <div className="flex flex-col justify-start">
          <button className="flex flex-col text-start items-start">
            <span className="inline-flex items-center gap-1 text-start text-xl font-semibold decoration-sky-500 decoration-2 hover:underline">
              {album.Name}
            </span>
            <span
              onClick={() =>
              ...
              className="inline-flex items-center gap-1 text-start text-sm font-normal decoration-sky-500 decoration-2 hover:underline"
            >
              {album.ArtistItems[0].Name}
            </span>
            {/* show the production year in a chip */}
            <span className="inline-flex mt-1.5 items-center gap-1 text-start text-xs font-normal bg-slate-800 text-white py-0.5 px-2.5 rounded-md shadow-sky-500/20 shadow-xl w-min ring-1 ring-slate-700">
