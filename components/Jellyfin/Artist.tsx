...
const Artist = ({ artist }: Props) => {
  ...
  return (
    <div
      ...
      className="group-one flex w-48 flex-col select-none items-center justify-between gap-3 rounded-xl p-4 pb-4 text-sm text-slate-700 transition-all duration-300 ease-in-out hover:cursor-pointer hover:bg-slate-100 dark:text-white dark:hover:bg-slate-800/50 active:scale-95"
    >
