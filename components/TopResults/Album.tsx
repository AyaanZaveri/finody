      ...
      <div className="relative flex flex-col gap-5 px-6">
        ...
        <div className="flex flex-col justify-start gap-1.5">
          <div className="flex flex-row">
            <span className="inline-flex gap-1 text-3xl font-semibold text-stone-700 decoration-emerald-500 transition duration-300 ease-in-out hover:underline dark:text-white">
              {albumInfo.title}
            </span>
          </div>
