        ...
        <div className="pt-6">
          ...
          <form className="flex flex-col gap-y-3 text-base">
            ...
            <input
              ...
              id="serverUrl"
              value={serverUrl}
              className="w-2/3 text-slate-500 text-base rounded-md border-none outline-none shadow-sm ring-1 ring-gray-300 focus:bg-gray-100 focus:ring-gray-500 dark:text-white dark:ring-gray-700 dark:bg-gray-800 dark:focus:ring-gray-500 dark:focus:bg-gray-700 transiton duration-200"
